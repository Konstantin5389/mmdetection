...
import functools
from torch.nn.init import xavier_normal as xavier_init
from torch.nn.init import constant as constant_init
...
class SeparableConv(BaseModule):
...
class WeightedInputConv(BaseModule):
    def __init__(self,
                 in_channels,
                 out_channels,
                 num_ins,
...
class WeightedInputConv_V2(BaseModule):
    def __init__(self,
                 in_channels,
                 out_channels,
                 num_ins,
...
class ResampingConv(BaseModule):
    """
    in_channels,  
    in_width, 
    target_width, 
